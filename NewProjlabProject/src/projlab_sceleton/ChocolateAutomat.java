...
public class ChocolateAutomat extends Element implements Steppable {
	...
	public boolean collide(Orangutan o) {System.out.println("ChocolateAutomat.collide(Orangutan o) "); return true;}
	
	public boolean collide(Panda p) {System.out.println("ChocolateAutomat.collide(Panda p) "); return true;}
